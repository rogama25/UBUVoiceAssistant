...
En Ubuntu, para ejecutar la aplicación hay que descargar el \href{https://github.com/adp1002/UBUVoiceAssistant/releases}{proyecto de GitHub} (el archivo \textbf{Source code (tar.gz)}) y  descomprimirlo en la carpeta personal.
...
\begin{enumerate}
	\item \textbf{cd \detokenize{~}/UBUVoiceAssistant-1.X/src}
