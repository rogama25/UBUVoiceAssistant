...
% Datos de portada
\title{UBUVoiceAssistant\\Interacción por voz con la plataforma Moodle}
\author{\nombre}
...
\noindent Que el alumno D. \nombre, con DNI 71363793Z, ha realizado el Trabajo final de Grado en Ingeniería Informática titulado UBUVoiceAssistant interacción por voz con la plataforma Moodle. 
...
\begin{abstract}
	Voice assistants are a new technology whose use has exploded over the last few years. These assistants allow us to perform varying tasks in an interactive and very comfortable way. Tasks such as check the weather, an Internet search, go shopping... in short a wide variety of tasks in many of fields.
	
	In the educational enviroment, online teaching and virtual classrooms have had an important technological development too, Moodle being a reference in this field. However, voice assistants have not been used in this area, despite of its features and the posibilities they bring to students. This is the reason that the idea of the project was conceived, to bring the users of these educational platforms a new way of interacting with them, in a quicker and easier way.
	
	UBUVoiceAssistant is a client application developed in Python using Mycroft as the voice assistant. This application allows the user to obtain information of the academic course through voice commands or text input, without the need of knowing what is Moodle or what steps he/she needs to do in order to retrieve this information.
\end{abstract}
